...
function DeleteInstructorSchedule({
  onClose,
  schedules,
  onRefreshSchedules,
  subjects,
  ...
  // Group schedules by start time, day, and instructor
                ...
                >
                  <div className="flex gap-4 items-center">
                    <input
                      ...
                      onChange={() =>
                        handleCheckboxChange(schedule.schedule_id)
                      }
                    />
                    <span
...
export default DeleteInstructorSchedule;
